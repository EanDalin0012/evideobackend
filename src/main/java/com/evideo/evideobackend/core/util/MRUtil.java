...
public class MRUtil extends StringUtils {
     ...
     */
    public static void NVL(JsonObject input) {
        NVL(input, SPACE);
    }
     ...
     */
    public static void NVL(JsonObject input, String defaultStr) {
        if (input != null) {
...
//        return MRNullUtil.isNone( result );
     ...
     * @fullPath
     */
    public static JsonObjectArray convertToMultiLine(String str, int length) {

        JsonObjectArray outputData = new JsonObjectArray();

        if (str.length() <= length) {

            JsonObject line = new JsonObject();
            line.setString("line", str);
            outputData.addJsonObject(line);
            ...
            do {
                ...
                if (tobeString.length() <= length) {
                    ...
                    outputData.addJsonObject(lastLine);
                }
